  ...
  return (
    <main className="min-h-screen relative">
      <ErrorBoundary>
        ...
        {/* Parallax neon bloblar */}
        <ParallaxLayer strength={6} className="absolute inset-0 -z-10">
          <div className="blob w-[520px] h-[520px] top-10 left-[-120px]"></div>
          <div className="blob w-[420px] h-[420px] bottom-10 right-[-120px]"></div>
        </ParallaxLayer>
        ...
        {/* Üst marquee */}
        <div className="relative z-10 max-w-6xl mx-auto pt-6 md:pt-10">
          <Marquee className="text-xs tracking-widest uppercase" text="ukalai • cinematic • director • generative • realtime • " />
        </div>
          ...
          <AnimatedSection delay={0.05}>
            <div className="panel grid gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <motion.button onClick={submit} disabled={busy} className="btn-primary" whileTap={{ scale: 0.98 }}>
